...
if __name__ == '__main__':
    ...
    parser.add_argument("-C", "--configuration",default="config/train_voicebank.toml", required=False, type=str, help="Configuration (*.toml).")
    parser.add_argument("-R", "--resume",default=False, action="store_true", help="Resume the experiment from latest checkpoint.")
    parser.add_argument("-V", "--only_validation", action="store_true", help="Only run validation. It is used for debugging validation.")
    parser.add_argument("-N", "--num_gpus", type=int, default=1, help="The number of GPUs you are using for training.")
