...
class Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        for noisy, clean in self.train_dataloader:
            ...
            with autocast(enabled=self.use_amp):
                ...
                # CRM shape: torch.Size([20, 2, 128, 193])
    ...
    def _validation_epoch(self, epoch):
        ...
        for i, (noisy, clean, name, speech_type) in enumerate(self.valid_dataloader):
            ...
            # print("enhanced_real.shape:  ", enhanced_real.shape)
            # print("enhanced_imag.shape: ", enhanced_imag.shape)
            
            enhanced_complex = torch.complex(enhanced_real, enhanced_imag)
            if isinstance(enhanced_complex, complex):
                print("enhanced_complex is a complex tensor.")
