...
from speech_enhance.fullsubnet.model.DITFA import DeepInteractiveTemporalFrequencyAttentionModule
# for log
...
class Model(BaseModel):
    ...
    def forward(self, noisy_mag):
        ...
        # sb_output_inter = sb_output_inter.permute(0, 1, 3, 2).contiguous()  # [B, C, T, F]
        # fb_output = fb_output.permute(0, 1, 3, 2).contiguous()  # [B, C, T, F]
